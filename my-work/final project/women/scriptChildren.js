...
let vizChildren = d3.select("#visualizationChildren")
    .append("svg")
...
console.log(sortedByCountry);
    ...
    //x axis
      ...
      let xAxisGroup = vizChildren.append("g").attr("class", "xaxis");
      ...
      let infoText = vizChildren.append("text")
      .attr("x", w/2)
      .attr("y", 150)
...
let graphGroup = vizChildren.append("g").classed("graphGroup", true);
...
function showchildren(year){
  ...
  d3.forceSimulation(sortedByCountry)
    ...
    .force("forceX", d3.forceX(function(d){
      return xScale(d.records[2009].children);
    }))
...
function adjustVizHeight(){
  vizChildren.style("height", function(){
    w = parseInt(vizChildren.style("width"), 10);
    h = w*heightRatio;
    return h;
  })
}
