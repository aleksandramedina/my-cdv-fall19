...
let vizMovement = d3.select("#visualizationMovement")
    .append("svg")
...
console.log(sortedByCountry);
    ...
    //x axis
      ...
      let xAxisGroup = vizMovement.append("g").attr("class", "xaxis");
    ...
    let infoText = vizMovement.append("text")
    .attr("x", w/2)
    .attr("y", 150)
...
let graphGroup = vizMovement.append("g").classed("graphGroup", true);
...
let enteringGroups = enteringElements.append("g").classed("datapoint", true)
  ...
  .on("mouseover", function(d, i){
    ...
    infoText.text(d.name + ", " + d.records[currYear].mobility);
})
...
function showmobility(currYear){
...
console.log("this is output value" + output);
  ...
  d3.forceSimulation(sortedByCountry)
    ...
    .force("forceX", d3.forceX(function(d){
      return xScale(d.records[currYear].mobility);
