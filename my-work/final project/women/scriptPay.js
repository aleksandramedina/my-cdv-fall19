...
console.log(sortedByCountry);
    ...
    //x axis
      ...
      let xAxisGroup = vizPay.append("g").attr("class", "xaxis");
    ...
    let infoText = vizPay.append("text")
    .attr("x", w/2)
    .attr("y", 150)
...
let graphGroup = vizPay.append("g").classed("graphGroup", true);
...
let enteringGroups = enteringElements.append("g").classed("datapoint", true)
  ...
  .on("mouseover", function(d, i){
    ...
    infoText.text(d.name + ", " + d.records[currYear].pay);
})
