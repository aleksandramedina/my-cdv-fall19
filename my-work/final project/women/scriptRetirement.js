...
let vizRetirement = d3.select("#visualizationRetirement")
    .append("svg")
...
console.log(sortedByCountry);
    ...
    //x axis
      ...
      let xAxisGroup = vizRetirement.append("g").attr("class", "xaxis");
    ...
    let infoText = vizRetirement.append("text")
    .attr("x", w/2)
    .attr("y", 150)
...
let graphGroup = vizRetirement.append("g").classed("graphGroup", true);
...
function showretirement(year){
  ...
  d3.forceSimulation(sortedByCountry)
    ...
    .force("forceX", d3.forceX(function(d){
      return xScale(d.records[2009].retirement);
    }))
...
function adjustVizHeight(){
  vizRetirement.style("height", function(){
    w = parseInt(vizRetirement.style("width"), 10);
    h = w*heightRatio;
    return h;
  })
}
